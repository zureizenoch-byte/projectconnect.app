    ...
    <form action={action} className="surf" style={{ padding: 'clamp(22px,3vw,34px)', marginTop: 22 }}>
      ...
      <div style={{ maxWidth: 420, marginTop: 20 }}>
        ...
        <label className="fld">
          ...
          <input name="new_password" type="password" required minLength={8} maxLength={20}
        ...
        <label className="fld">
          ...
          <input name="confirm_password" type="password" required maxLength={20}
            autoComplete="new-password"
  ...
  return (
    <div className="surf" style={{
      ...
      <p className="mute small" style={{ marginTop: 6, maxWidth: '60ch' }}>
        ...
        uploaded photos. Seats you hold are released for other members. Posts and comments stay,
        shown as a former member, so other people's threads still read. This cannot be undone.
      </p>
